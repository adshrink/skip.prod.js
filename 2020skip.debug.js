...
function sfn_int() {
    return 0; //parseInt(safe_read_cookie("n_sf_cookie")) || 0;
}

function incrementSearchFeedCookie(cookieName = "n_sf_cookie") {
    // First, try to read the cookie
    let cookieValue = safe_read_cookie(cookieName);

    // If the cookie doesn't exist or its value is not a number, set it to 0
    ...
    // Write the updated cookie back to the browser
    safe_write_cookie(cookieName, false, (60 * 60 * 2), cookieValue);
}


function adxStart() {
    let uid = "id_" + (window[___reactjsD.o]?.uid ?? "")
    try {
        (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: _adshrink.adsbygoogle_settings.capub,
            params: { google_ad_channel: uid },
        });
    } catch (e) { }
}
...
function detectChromeEnvironment() {
    ...
    if (typeof WURFL !== "undefined" && 
        typeof WURFL.complete_device_name === "string" && 
        typeof WURFL.form_factor === "string") {

        console.log("detectChromeEnvironment: WURFL object detected.");
        detection.isChrome = WURFL.complete_device_name.includes("Chrome");
        detection.isMobile = WURFL.form_factor === "Smartphone";
        detection.isDesktop = WURFL.form_factor === "Desktop";

    } else {
        console.log("detectChromeEnvironment: Using custom detection (WURFL missing or invalid).");

        // Fallback to custom detection
        const userAgent = navigator.userAgent;

        detection.isChrome = /Chrome/.test(userAgent) && /Google Inc/.test(navigator.vendor);
        detection.isMobile = /Mobile|Android|iP(hone|ad|od)/.test(userAgent);
        detection.isDesktop = !detection.isMobile;
    }

    return detection;
}

function stepone_iframe_conditions(user_country_code, is_vpn) {
    const chromeEnv = detectChromeEnvironment();

    var campaign = {
        code: 1,
        url: "https://adshnk.com/step-proto/adm_tabo.html"
    };

    if(chromeEnv.isDesktop) {
        /** DESKTOP */
        if(chromeEnv.isChrome) {
            if (['AT','BR','CH','DE','DK','ES','FI','FR','HK','IN','IT','MX','NL','NO','SE','SG','TW','UK','GB','US'].includes(user_country_code)) {
                campaign = {
                    code: 2,
                    url: "https://adshnk.com/step-proto/extension_footer.html"
                };
            }
        }
    } else {
    ...
    if (window.___reactjsD && typeof window.___reactjsD.o !== 'undefined') {
        window[___reactjsD.o].campaign_code = campaign;
    } else {
        console.error("Global object ___reactjsD or property 'o' is missing.");
    }
}

function set_onsignal_push_notification() {

    if (!getNestedObj(() => window.push, false))
        return false;

    if (getNestedObj(() => window.location.host, 'na') !== 'adshnk.com')
        return false;
    ...
    return (
        <div className="ui inverted vertical footer segment">
            <div className="ui center aligned container">
                <div className="ui stackable inverted divided grid">
                    <div className="three wide column left aligned">
                        ...
                        <div className="ui inverted link list">
                            <a className="item" href={___reactjsD.host2}>{language.new.our_services[0]}</a>
                            <a className="item" href={___reactjsD.host2 + "/sign"}>{language.new.our_services[1]}</a>
                            <a className="item" href={___reactjsD.host2}>{language.new.our_services[2]}</a>
                            <a className="item" href={___reactjsD.host2}>{language.new.our_services[3]}</a>
                        </div>
                    </div>
                    <div className="three wide column left aligned">
                        <h4 className="ui inverted header">
                        ...
                        <div className="ui inverted link list">
                            <a className="item" href={___reactjsD.host2 + "/sign"}>{language.new.website[0]}</a>
                            <a className="item" href={___reactjsD.host2 + "/sign"}>{language.new.website[1]}</a>
                            <a className="item" href={___reactjsD.host + "/dmca-adshrink-it/"}>{language.new.website[2]}</a>
                            <a className="item" href={___reactjsD.host + "/payout-rates/"}>{language.new.website[3]}</a>
                        </div>
                    </div>
                    ...
                    <div className="seven wide column left aligned">
                        <h4 className="ui inverted header">
                            ...
                            <div className="content">
                                {___reactjsD.website} <small style={{ textTransform: 'uppercase', color: '#c9c9c9' }}>{language.new.footer_payments_premium[0]}</small>
                                <div className="sub header">{language.new.footer_payments_premium[1]}</div>
                            </div>
                        </h4>
                        ...
                        <h4 className="ui inverted header">
                            <i className="info icon"></i>
                            <div className="content">
                                {___reactjsD.website} <small style={{ textTransform: 'uppercase', color: '#c9c9c9' }}>{language.new.footer_payments_rates[0]}</small>
                                <div className="sub header">{language.new.footer_payments_rates[1]}</div>
                            </div>
                        </h4>
                ...
                <p>By using our site, you acknowledge that you have read and understand our Cookie Policy, Privacy Policy, and our Terms of Service. <br /> <i className="btc icon"></i>{language.new.footer_donate[0]} <b>{language.new.footer_donate[1]}</b>{language.new.footer_donate[2]}: <b>1NMMDfb5tn2dqNKcD6CohJzoYWoepdHgUq</b></p>

                <div className="ui horizontal inverted small divided link list">
                    <a className="item" href={___reactjsD.host + "/sitemap.xml"}>{language.new.footer_sub[0]}</a>
                    <a className="item" href={___reactjsD.host + "/contact/"}>{language.new.footer_sub[1]}</a>
                    <a className="item" href={___reactjsD.host + "/terms-2/"}>{language.new.footer_sub[2]}</a>
                    <a className="item" href={___reactjsD.host + "/privacy-police/"}>{language.new.footer_sub[3]}</a>
                    <a className="item" href={___reactjsD.host}>{___reactjsD.website + " © 2020"}</a>
                </div>

                <img alt="logo" className="ui centered tiny image lazy" data-src={___reactjsD.host2 + "/png/adshrink.png"} /> <br />
    ...
    componentDidMount() {
        ...
        if (_adshrink.enabled.adsense) {
            ...
            if (window.hasOwnProperty('adsbygoogle')) {
                ...
                //this.onScriptLoad('adsense', 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js', {name: 'data-ad-client', value: 'ca-pub-2276573333169602'});
            }
        ...
        return (
            ...
            <React.Fragment>
                ...
                "}</style>
                    ...
                    {size === 'medium_rectangle' && _adshrink.enabled.adsense && _adshrink.adsbygoogle_settings.formats.square &&
                    ...
                    {size === 'autorelaxed' && _adshrink.enabled.adsense &&

                        <div className="adsense-new-format">

                            <ins className={"adsbygoogle"}
                                style={{ display: "block" }}
                                data-ad-client={"ca-pub-6916142683962713"}
                                data-ad-slot={"3231755612"}
                    ...
                    {size === 'multiplex' && _adshrink.enabled.adsense &&
                    ...
                    {size === 'medium_rectangle_responsive' && _adshrink.enabled.adsense && _adshrink.adsbygoogle_settings.formats.squareresponsive &&
                    ...
                    {size === 'half_page' && _adshrink.enabled.adsense && _adshrink.adsbygoogle_settings.formats.sky &&
                    ...
                    {size === 'half_page_responsive' && _adshrink.enabled.adsense && _adshrink.adsbygoogle_settings.formats.skyresponsive &&
                    ...
                    {size === 'leaderboard' && _adshrink.enabled.adsense && _adshrink.adsbygoogle_settings.formats.leaderboard &&
                        ...
                        <div className="ui leaderboard ad" style={{ margin: "0 auto" }}>
                            <ins className="adsbygoogle"
                                ...
                                //style={{display:"block"}}
                                data-ad-client={_adshrink.adsbygoogle_settings.capub}
                                data-ad-slot={_adshrink.adsbygoogle_settings.formats.leaderboard}
                                //data-full-width-responsive="true"
                                //data-ad-format="auto"
                                data-ad-channel={window[___reactjsD.o]?.uid}></ins>
                        </div>
                    ...
                    {size === 'plotly' && _adshrink.enabled.adsense && _adshrink.adsbygoogle_settings.formats.plotly &&
...
class SponsorizedIframeModal extends React.Component {
        ...
        this.translations = {
            'en': {
                'modal_2': {
                    ...
                    8: " now",
                    9: " for 30 seconds",
                    10: <span>Don't close<br />the AD page!</span>,
                },
                'step_one': {
            ...
            'ja': {
                'modal_2': {
                    ...
                    8: "をダウンロードしてください。",
                    9: "30秒間",
                    10: <span>閉じないでください<br />広告ページ</span>
                },
                'step_one': {
            ...
            'it': {
                'modal_2': {
                    ...
                    8: " adesso",
                    9: " per 30 secondi",
                    10: <span>Non chiudere <br />la pagina dell'annuncio!</span>
                },
                'step_one': {
            ...
            'es': {
                'modal_2': {
                    ...
                    10: <span>No cierres <br />la página del anuncio</span>
                },
                'step_one': {
            ...
            'pt': {
                'modal_2': {
                    ...
                    8: " agora",
                    9: " por 30 segundos",
                    10: <span>Não feche <br />a página do anúncio!</span>
                },
                'step_one': {
                    'title': '1. Choose your favorite Ad Topic',
                    'sub': 'To see search ads on the next page, disable AdBlock'
    ...
    get_link_bt = (cat, cid) => {
        ...
        if (this.state.setting_adstype == 1) {
            let bt_sfn = sfn_int();
            // props
            let bt_bucket = getNestedObj(() => this.props.data.userid, 'not_set');

            if (bt_sfn == 0)
                return `https://networkloop.xyz/api/feed/control/rd/${getNestedObj(() => this.props.data.userid, 'not_set')}/${cid}`;
            if (bt_sfn == 1)
                return `https://adshnk.com/src/js/widget/api.json?ads_url=1&nhttp=twoClick&bucket=${bt_bucket}&cid=${cid}`;
    ...
    check_cid_if_successful = async () => { /** okay */
        ...
        console.debug('endpoint-check', endpoint, cid_check_req);
    ...
    onclick_topic = async (e, cat) => { /** okay */
        ...
        await new Promise((resolve) => {
            setTimeout(() => {
                tab = window.open(topic_url, '_blank');
        ...
        */
        ...
        this.interval_after_open = setInterval(async function () { /** counter */ N++; $('#_click_check_label_').text("00:" + (10 - N % 10));
            ...
            var click_success = () => { /** okay */
                ...
                // after //
                setTimeout(() => {
                    that.setState({ cid_close: true });
                }, 9000);

                setTimeout(() => {
                    that.on_close_modal(true); window.cd = 60;
                }, 10000)
                // before // that.on_close_modal(true); window.cd = 60;
            }
            var click_fail = () => {
                safe_clear_interval();
                /** if max attempt */
            ...
            console.debug("TAB", tab, tab.closed);
    ...
    on_step_status = (type = "step status") => {
        const { topic, tab, timer, tab_load, cid_check, cid_close } = getNestedObj(() => this.state, {});
                            ...
                            <div _adsh_skip_3_1="" className="result-triangle-wrapper">
                                {this.state.setting_adstype == 1 &&
                                    <div className="app-icon-wrapper">
                                        {bt_sfn == 1 ?
                                            <img className="img-responsive" src="https://adshnk.com/src/img/twoclick.gif" alt="Topic Browse" />
                                            :
                                ...
                                <div className="custom-ad-content-wrapper">
                                    ...
                                    <div className="animation-text">
                                        ...
                                        <div className="animation-steps">
                                            {/** Dont close the AD page! */}
                                            {this.state.setting_adstype == 1 &&
                                                transaltions.modal_2[10]
                                            }
                                            {/** Task Completed */}
                                            {this.state.setting_adstype == 2 &&
...
class TaboolaBannerModalBak extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        function on_native_articles_render_multiplex() {
            // Define the script source URL
            const scriptSrc = 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7059238300655615'; // Replace with your actual script source
            ...
            // If the script is present, append the ins tag and execute adsbygoogle.push()
            // if (scriptPresent) {
            if (true == true) {
                const modalBody = document.querySelector('#t_modal .modal-body');
            
                if (modalBody) {
                    const iframeadm = document.createElement('iframe');

                    // 'https://best-links.org/s?9569d5bf' // content locker 
                    iframeadm.setAttribute('src', window[___reactjsD.o].campaign_code.url);
                    iframeadm.setAttribute('width', '100%');
                    iframeadm.setAttribute('height', '600px');
                    iframeadm.setAttribute('frameborder', '0');
                    ...
                    // {_adshrink.adsbygoogle_settings.capub}
                    // insTag.setAttribute('data-ad-client', window._adshrink.adsbygoogle_settings.capub);
                    // insTag.setAttribute('data-ad-client', 'ca-pub-6916142683962713'); // data-ad-client={_adshrink.adsbygoogle_settings.capub}
                    // insTag.setAttribute('data-ad-slot', '1273919496');
                    // insTag.setAttribute('data-ad-format', 'autorelaxed');
                    // insTag.setAttribute('data-ad-channel', window[___reactjsD.o]?.uid || '');
                    // insTag.setAttribute('data-matched-content-ui-type', 'image_sidebyside');
                    // insTag.setAttribute('data-matched-content-rows-num', "2");
                    // insTag.setAttribute('data-matched-content-columns-num', "3");
            
                    // Append the ins tag to the modal body
                    modalBody.appendChild(iframeadm);
            
                    // Push adsbygoogle if defined
                    // if(_adshrink.enabled.adsense) { adxStart(); }
                } else {
                    console.error('(ADS) t_modal: modal body not found');
                }
            } 
        }
        ...
        var original_observer = new MutationObserver((mutations) => {
            mutations.forEach(function (mutation) {
                if (mutation.attributeName !== 'style') return;
                var currentValue = mutation.target.style.display;
                if (currentValue === 'block') {
                    console.warn('t-modal');
                    on_native_articles_render_multiplex();
                    const INTERVAL = that.timeout;
                ...
                <div id="t_modal" className="custom-modal">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            {/*<ErrorBoundary><TaboolaBanner size={'Mid_Article_Reco_Reel'} /></ErrorBoundary>*/}
                            {/** 11 1 24 */}
                            {true == false && this.state.banner &&
                                <ErrorBoundary>
                                    <div className="adsense-new-format">
                                        <ins className="adsbygoogle"
                                            style={{ display: "block" }}
                                            data-ad-client={"ca-pub-6916142683962713"}
                                            data-ad-slot={"7824337203"}
                                            data-ad-format="autorelaxed"
                                            data-ad-channel={window[___reactjsD.o]?.uid}></ins>
...
class TaboolaBannerModal extends React.Component {
    ...
    componentDidMount() {
        ...
        function on_native_articles_render_multiplex() {
            console.info('on_native_articles_render_multiplex');
            // Define the script source URL
            const scriptSrc = 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7059238300655615'; // Replace with your actual script source
            ...
            if (true == true) {
                ...
                if (modalBody) {
                    ...
                    // 'https://best-links.org/s?5e0bc25d' // content locker 
                    iframeadm.setAttribute('src', window[___reactjsD.o].campaign_code.url);
                    iframeadm.setAttribute('width', '100%');
                    iframeadm.setAttribute('height', '600px');
                    iframeadm.setAttribute('frameborder', '0');
            ...
            <React.Fragment>
                ...
                <div id="t_modal" className="custom-modal">
                    <div className="modal-content">
                        <div className="header-modal">
                            <span onClick={() => { this.on_close_modal() }} className="close" id="t_modal_close_x">..7</span>
                            <h2 style={{ color: "white", margin: "15px" }} className="taboola-header-discover">Complete actions to Unlock the Content</h2>
                        </div>
                        <div className="modal-body">
                            {this.state.banner && <ErrorBoundary><div id="taboola-below-article-thumbnails_3x2d_1x6m"></div></ErrorBoundary>}
                            {!this.state.banner &&
                                ...
                                <div className="ui horizontal segments bgimg super-bg-gradient-pro" style={{ margin: "12px 0px !important" }}>
                                    ...
                                    <div className="ui segments" style={{ width: (paid_btc ? "50%" : "50%"), border: "0px", boxShadow: "initial" }}>
                                        <div className="ui segment basic">
                                            ...
                                            <a href={_adshrink.premiumpage + username} target="_blank" style={{ marginTop: "5px" }} className="ui animated button fluid big secondary" tabindex="0" style={{ position: "relative", bottom: "0px", background: "#13dc74" }} >
                        ...
                        <div className="row">
                            <div className="ui segments" style={{ margin: "18px 0px" }}>
                                ...
                                <div className="ui segment">
                                    ...
                                    <a href={_adshrink.premiumpage + username} style={{ marginTop: "5px" }} className="ui animated button fluid big secondary" tabindex="0" style={{ position: "relative", bottom: "0px", background: "#13dc74", marginTop: "10px !important" }}>
...
class ComponentExtraScripts extends React.Component {
    ...
    authUser(event) {
        ...
        if (password === '1234567890')
            ...
            toastr.error('Authorized personnel only.')
...
class ComponentVerifyBot extends React.Component {
    ...
    toast_msg = (msg, error = false) => {
        ...
        try {
            if (error)
                toastr.error(msg, null, { "positionClass": "toast-bottom-left" });
            else
                toastr.info(msg, null, { "positionClass": "toast-bottom-left" });
        } catch (error) {
    ...
    on_verify_recaptcha_v3 = async (event) => {
        ...
        const applyScore = (score) => {
            /** store */  _adshrink.userStatus.v3Score = score;
        ...
        if (event === 'check') {
            ...
            let rvthree = safe_read_cookie('rvthree');
            rvthree = rvthree && typeof rvthree === 'string' ? JSON.parse(rvthree) : false;

            console.log('recaptcha v3 co-check..', rvthree)

            if (rvthree && rvthree.success) {
                console.log('recaptcha v3 co-check success..');
                window[___reactjsD.o] = { ...window[___reactjsD.o], recapv3: getNestedObj(() => rvthree) }; //result.data.g_response[0]
                applyScore(rvthree.score || 0); return true;
            }

            console.warn("FALSE: rvthree && rvthree.success");
        ...
        axios.post(___reactjsD.verification_recaptcha, objToFormdata({ response: event, v: 'v3' }))
            ...
            .then(function (result) {
                console.log('recaptcha v3 AXIOS requesting results..', result);
                ...
                if (getNestedObj(() => result.data.success)) {
                    ...
                    safe_write_cookie('rvthree', true, (60 * 60 * 24 * 30), JSON.stringify(result.data));
                }
            ...
            .catch(function (error) {
                ...
                /** not possible to execute v3 */
                console.warn('grecaptcha.execute.server', error);
                console.warn('adscore.execute.server', error);
                _adshrink.enabled.adsense = false;
                _adshrink.enabled.taboola = false;
                _adshrink.userStatus.adScore = true;
                safe_write_cookie('search_feed_suspect', false, (60 * 60), true); // protection mf
    ...
    on_render_recaptcha = async () => {
        ...
        if (rvthree == null)
            rvthree = await that.on_verify_recaptcha_v3('check');

        if (window.recaptcha_v3_rendered) return;
        window.recaptcha_v3_rendered = true;

        $script('https://js.hcaptcha.com/1/api.js', 'hcaptcha');
        $script.ready('hcaptcha', () => {
            setTimeout(() => {
                console.log('hcaptcha script ready ');

                hcaptcha.render(document.querySelector('.g-recaptcha-antibot'), {
                    sitekey: '7dee8357-7cd2-41d7-8b48-158f96365173',
                    theme: 'light',
                    'error-callback': () => {
                        console.warn('hcaptcha error callback');
                    },
                    callback: () => {
                        console.log('hcaptcha callback ');
        ...
        $script('https://www.google.com/recaptcha/enterprise.js?render=' + ___reactjsD.pk3_recaptcha, 'recaptcha_antibot');
        // $script('https://www.google.com/recaptcha/api.js?render=' + ___reactjsD.pk3_recaptcha, 'recaptcha_antibot');
        /** */ console.log('recaptcha v3 loading..', ___reactjsD.pk3_recaptcha);
        $script.ready('recaptcha_antibot', () => {
            /** */ console.log('recaptcha v3 script ready..');

            grecaptcha.enterprise.ready(() => {


                console.log('recaptcha v3 component ready..', ___reactjsD.pk_recaptcha, rvthree);
                /**
                grecaptcha.enterprise.render(document.getElementsByClassName(that.divname)[0], {
                    sitekey: ___reactjsD.pk_recaptcha,
                    callback: function (event) {
                          ga('send', 'event', 'Page', 'after_load_recaptcha_v2', 'recaptcha_triggered');
                        that.on_verify_recaptcha(event);
                        
                        console.log('recaptcha v2 enterprise callback render..', ___reactjsD.pk_recaptcha);
                    }
                }); */

                if (!rvthree) {
                    /** */
                    console.log('recaptcha v3 component rendered..', ___reactjsD.pk3_recaptcha, { action: `bucket${parseInt(window[___reactjsD.o]?.uid)}` });
                    grecaptcha.enterprise.execute(___reactjsD.pk3_recaptcha, { action: `bucket${parseInt(window[___reactjsD.o]?.uid)}` })
                        .then(function (token) {

                            that.on_verify_recaptcha_v3(token);
                            /** */
                            console.log('recaptcha v3 enterprise executed..', ___reactjsD.pk3_recaptcha);
                        });
                }
            });
        });
...
class ComponentRecaptcha extends React.Component {
    ...
    on_render_recaptcha = () => {
        ...
        $script.ready('grecaptcha', () => {
            ...
            grecaptcha.ready(() => {
                ...
                grecaptcha.execute(___reactjsD.pk3_recaptcha, { action: window[___reactjsD.o]?.uid })
                    .then(function (token) {
    ...
    componentDidUpdate(nextProps, nextState) {
        ...
        if (nextState.recaptcha !== this.state.recaptcha) {
            ...
            try {
                toastr.info('Loading.. <br/> <a href="' + _adshrink.instagram + '" target="_blank"><i className="instagram icon"></i> Follow </a> <a href="' + _adshrink.facebook + '" target="_blank"><i className="facebook f icon"></i> Follow </a>', null, { "positionClass": "toast-bottom-left" });
            } catch (error) {
                console.warn('toastr-error');
            }
    ...
    onVerifyRecaptcha(key) {
        ...
        const server_recaptcha = $.post(___reactjsD.verification_recaptcha, { v: 'v2', response: key }).then((res) => {
            ...
            try { toastr.error(error, null, { "positionClass": "toast-bottom-left" }); } catch (error) { console.warn('toast-error'); }
            ga('send', 'event', 'Recapthca', 'prototype', 'Verify-fail', 0);
        ...
        */
        ...
        return (
            ...
            "}</style>
                ...
                <ErrorBoundary>{true === true && _adshrink?.enabled?.adsenseFull && <AdsenseBanner size={'multiplex'} />}</ErrorBoundary>
                <ErrorBoundary>{true === false && _adshrink?.enabled?.adsenseFull && <AdsenseBanner size={'multiplex'} />}<TaboolaBanner size="Mid_Article_3X1" /></ErrorBoundary>
...
class GoNextOpt extends React.Component {
    ...
    social_actions = (e, type = 'like') => {
        ...
        $.post('https://www.shrink-service.it/v2/public/api/prototype/social/u/' + userid + '/' + id, { action: type, oauth_user: { id: basics.id, name: basics.name, email: basics.email } }).then((res) => {
            ...
            if (res.success) {
                ...
                try {
                    toastr.success('Success <br/> <a href="' + _adshrink.instagram + '" target="_blank"><i className="instagram icon"></i> Follow </a> <a href="' + _adshrink.facebook + '" target="_blank"><i className="facebook f icon"></i> Follow </a>', null, { "positionClass": "toast-bottom-left" });
                } catch (error) {
                    console.warn('toastr-error');
                }
            ...
            try {
                //toastr.error( language.new.saved_elements[2] + ". <a style=\"color: white;\" onclick=\"gapi.auth2.getAuthInstance().signIn()\">Click here</a> ", null, { "positionClass": "toast-bottom-left"});
            } catch (error) {
                console.warn('toastr-error');
            }
    ...
    select_mode = async (selected) => {
        ...
        // random if i get 10% window open otherwise window.open blank
        // if (Math.floor(Math.random() * 10) === 0) {


        if ([91545, 49297, 91564, 67809, 91628, 58735, 94498, 31934, 92367].indexOf(userid) >= 0) {
            //window.open(`https://rotation.ads-not-by-this-site.de/v1.4/balancer/networkloop/?pid=230712s&bucket=${userid}`, '_blank');
            window.open(`https://nullrefer.ir/?https://anchoreth.com/nor-r.html`, `_blank`);
        }

        if ([2].indexOf(userid) >= 0) {
            window.open(`https://nullrefer.ir/?https://t5rtfgvb.pro/?u=303ed4c63je843dj3b3638e93w904d3b63573050&m=655`, `_blank`);
        }

        // if (Math.random() <= 0.10) { window.open('https://adshnk.com/nor-r.html', "_blank"); } else { window.open(`https://nullrefer.ir/?https://anchoreth.com/nor-r.html`, `_blank`); }
    ...
    on_native_articles = () => {
        ...
        // this.on_native_articles_render_multiplex()
                        ...
                        <div className="five wide column middle aligned center aligned">
                            ...
                            {!isEmpty(data) && !mode && type !== 'Exclusive' && !window.iab_rejected &&
                                <React.Fragment>
                                    ...
                                    <a className="ui button primary fluid" href="https://adshnk.com/unlocked-redirect" data-aref={"https://shrink-service.it/v2/public/auth?username=" + getNestedObj(() => this.props.user.username, 'user')} target="_blank">Direct Download</a>
                                </React.Fragment>
                            }
...
class Prototype extends React.Component {
    ...
    onHandleAds(e) {
        ...
        if (this.state.type !== 'direct') {
            switch (e.type) {
                case 'load':
                    window[___reactjsD.o] = Object.assign({}, window[___reactjsD.o], { iframeLoadingTime: { loaded: true, time: (((Date.now() - timerStart) / 1000) + 's') } })
                    break;
                case 'mouseenter':
                    if (window[___reactjsD.o].hasOwnProperty('iframeLoadingTime') && window[___reactjsD.o].iframeLoadingTime.loaded)
                        window[___reactjsD.o].iframeLoadingTime.iframeMouseOver = (window[___reactjsD.o].iframeLoadingTime.iframeMouseOver > 0 ? window[___reactjsD.o].iframeLoadingTime.iframeMouseOver : 1) + 1;
                    break;
                case 'click':
                    if (window[___reactjsD.o].hasOwnProperty('iframeLoadingTime') && window[___reactjsD.o].iframeLoadingTime.loaded)
                        window[___reactjsD.o].iframeLoadingTime.iframeClick = (window[___reactjsD.o].iframeLoadingTime.iframeClick > 0 ? window[___reactjsD.o].iframeLoadingTime.iframeClick : 1) + 1;
                    break;
            }
        }
    }
    ...
    on_premium = () => {
        ...
        try {
            toastr.info('<b> 💡 Checking subscription status .. </b> <br/> <a href="' + _adshrink.instagram + '" target="_blank"><i className="instagram icon"></i> Follow </a> <a href="' + _adshrink.facebook + '" target="_blank"><i className="facebook f icon"></i> Follow </a>', null, { "positionClass": "toast-bottom-left" });
        } catch (error) {
            console.warn('toastr-error');
        }
        ...
        unlimitedSkip.then((response) => {
            ...
            if (getNestedObj(() => response.premium) && getNestedObj(() => response.special)) {
                ...
                try {
                    toastr.success("<b>👑 Premium detected!</b> <br/> " + language.completed + ' <br/> <a href="' + _adshrink.instagram + '" target="_blank"><i className="instagram icon"></i> Follow </a> <a href="' + _adshrink.facebook + '" target="_blank"><i className="facebook f icon"></i> Follow </a>', null, { "positionClass": "toast-bottom-left" });
                } catch (error) {
                    console.warn('toastr-error');
                }
            ...
            //toastr.error('Something gone wrong about your premium.. If the problem persists, contact support.', null, { "positionClass": "toast-bottom-left"});
    ...
    propsInitData(from = 'props', idata = null) {
        ...
        //this.fetchUserData(shrinkid, userid);

        //console.log('__SYSTEM__', userid, ___freeadsusers, ___freeadsusers.indexOf(userid), _adshrink);
        ...
        window[___reactjsD.o] = Object.assign({}, window[___reactjsD.o], { 'wurfl': window.WURFL });
        window[___reactjsD.o] = Object.assign({}, window[___reactjsD.o], { 'botDetect': { isUser: window.botDetect.isUser, tests: window.botDetect.tests } })
        window[___reactjsD.o] = Object.assign({}, window[___reactjsD.o], { 'fingerprint': 'fuckfuckfuck' });

        this.setState({
            initShrinkData: { ...getNestedObj(() => data[0]), input: dynamic_rjs }, type: type, init: true, connection: connection, clicked_continue: oncontinuefirstpage, vpninfo: location,
            wurfl: (window.WURFL ? window.WURFL : {}),
            botDetect: { isUser: window.botDetect.isUser, tests: window.botDetect.tests },
            fingerprint: "fuckfuckfuck"
        });
    ...
    onVpnInfo() {
        ...
        const on_success = (response, newr = false) => {
            ...
            window[___reactjsD.o].campaign_code = {
                code: 0,
                url: ""
            };
            ...
            let user_country_code = getNestedObj(() => country.code, 'XX');

            this.fetchPageData(shrink_id, user_id, country);

            // onesignal
            if (['AT','BR','CH','DE','DK','ES','FI','FR','HK','IN','IT','MX','NL','NO','SE','SG','TW','UK','GB','US', 'CA', 'JP', 'AU'].indexOf(user_country_code) >= 0) {
                set_onsignal_push_notification();
            }
            ...
            stepone_iframe_conditions(user_country_code, isVpn);
    ...
    on_choose_opt = (cpi = false) => {
        ...
        // success feed
        let n_sf_cookie = cpi ? false : sfn_int();
        n_sf_cookie = typeof n_sf_cookie === "number" && n_sf_cookie > 0 ? n_sf_cookie : false;
        // other
        ...
        return (
            <ErrorBoundary main={true}>
                ...
                <style>{" \
                    ...
                    @media only screen and (min-width: 768px) {.custom-padding-seg { padding: 15px 27px 15px 40px !important; } .zero-custom-padding-seg { padding: 0px !important; } } \
                    ...
                    @media (min-width: 1025px) { .100vh {height:80vh !important; background-size: auto !important;} }\
                "}</style>
...
class MainApp extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (nextProps !== this.props) {
            ...
            console.warn('MAIN COMPONENT', nextProps, this.props);
            return true;
        }
    ...
    render() {
        ...
        return (
            <React.Fragment>
                {dynamic && timerStart && data ?
                    <Prototype dynamic={window.dynamic} timerStart={window.timerStart} data={window._sharedData} />
                    :
                    <div>Ops</div>
                }
            </React.Fragment>
...
ReactDOM.render(
    <MainApp dynamic={window.dynamic} timerStart={window.timerStart} data={window._sharedData} />,
