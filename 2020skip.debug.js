...
var _adshrink = {
    ...
    adsense: 'automatic',
    push: 'automatic' ,
    enabled: { publift: true, skip: false, 
...
function ModalTCF(props) {
    ...
    return (
        <div className="ui basic modal" id="modal_fct">

            <h2 className="ui header">
                <i className="low vision icon" style={{WebkitMaskImage: "-webkit-gradient(linear, 0% 0%, 0% 100%, from(rgba(90, 50, 50, 0.8)), color-stop(0.5, rgba(119, 47, 26, 0.74)), to(rgba(123, 78, 32, 0.75)))", color: '#4184f3'}}></i>
                <div className="content">
                    {___reactjsD.website}
                    <div className="sub header" style={{color: '#c9c9c9'}}>{"Transparency & Consent Framework"}</div>
                </div>
            </h2>
                    ...
                    <div className="ui placeholder raised segment">
                        <div className="ui two column stackable center aligned grid">
                            ...
                            <div className="middle aligned row">
                                    ...
                                    <div className="ui icon header">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="sub header">
                                                Support this <b>user</b> and <b>automatically</b> get the Destination Link
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="column">
                                    <div className="ui icon header">
                                        <i className="adversal icon"></i>
                                        <div className="content">
                                            Data processing
                                            <div className="sub header">
                                                Accept data processing, cookies and disable your adblock.
                                            </div>
                                        </div>
                                        
                                    </div>
                                    <div style={{background: "#13dc74"}} className="ui primary button fluid" onClick={(e) => allow_all_tcf(e)}>
                                        Allow and reload!
                                    </div>
                                </div>
                            </div>
    ...
    render() {
        ...
        return(
            ...
            <React.Fragment>
                ...
                { size === 'medium_rectangle' && _adshrink.enabled.adsense && 
                ...
                { size === 'medium_rectangle_responsive' && _adshrink.enabled.adsense && 
                ...
                { size === 'half_page' && _adshrink.enabled.adsense &&
                ...
                { size === 'half_page_responsive' && _adshrink.enabled.adsense &&
                ...
                { size === 'leaderboard' && _adshrink.enabled.adsense && 
                ...
                { size === 'plotly' && _adshrink.enabled.adsense && 
...
class SponsorizedIframeModal extends React.Component {
    constructor(props) {
        ...
        this.endpoint = [
            'https://www.shrink-service.it/v3/api/pb/channels/bergfried/check?cid=',
                    ...
                    SETINTERVAL = setInterval(() => {
                        ...
                        if(parseInt(that.timeout) >= 6)
                            ...
                            if(!getNestedObj(() => that.state.banner, true)) 
                            {
                                ...
                                /** set initial state */
                                that.setState({banner:true, cid_required: _force_click, setting_modal: that.modal, setting_adstype: that.adstype});
                            }
    ...
    get_link_bt = (cat, cid) => {
        ...
        if(this.state.setting_adstype==1) {
            ...
            /** event */
            if(!getNestedObj(() => window.unique_offer, false))    
                ga('send', 'event', 'Page', 'app_installs', 'offer_open_unique');

            window.unique_offer = true; 
    ...
    onclick_topic = async (e, cat) => { /** okay */
        ...
        if( that.state.setting_adstype == 1 && this.state.cid_attempt>=2 && (window.cd<this.nextopening) )
        {   /** okay */
        ...
        if(that.state.setting_adstype == 2) {
            ...
            if(!getNestedObj(() => window._cpi_offer_open, true))
                ga('send', 'event', 'Page', 'app_installs', 'opened_cpi_offer_unique'); 
            window._cpi_offer_open = true;
        }
                ...
                <div id="si_modal" className="custom-modal">
                    <div className="modal-content">
                        <div className="header-modal">
                            <span onClick={() => {this.on_close_modal()}} className="close" id="si_modal_close_x" {...(this.state.setting_modal === 1 ? {adshnk_modal_1:""} : {adshnk_modal_2:""})}>×</span>
...
class ComponentVerifyBot extends React.Component {
    ...
    on_render_recaptcha = async () => {
        ...
        $script.ready('recaptcha_antibot', () => {
            ...
            grecaptcha.ready(() => {
                ...
                grecaptcha.execute(___reactjsD.pk3_recaptcha, { action: parseInt(window[___reactjsD.o]?.uid) })
                .then(function(token) { 
    ...
    on_allow_iab = () => {
        ...
        if ( !isEmpty($('#pre-captcha-iab-message-rejected')) )
            $('#pre-captcha-iab-message-rejected').css({display: 'none'})
    }
...
function makeid(length, predigit = false) {
                        ...
                        <div className="ui grid">
                            <div className="six wide computer eight wide tablet sixteen wide mobile column">
                                ...
                                <div className="ui label">
                                    <i className="play icon"></i> <a href="#"> {this.get_views()}</a>
                                </div>
                                <div className="ui label">
                                    <i className="heart icon"></i> <a href="#"> {this.getLikes()}</a>
                                </div>
                                <div className="ui label">
                                    <i className="comment icon"></i> <a href="#disqus_thread" data-disqus-identifier={ getNestedObj(() => this.props.data[0].id, 0) }>0</a>
                                </div>
                                <br/><br/>
...
class GoNextOpt extends React.Component {
    ...
    get_user_personalized_mode = (user_personalized = false) => {
        ...
        const sysC = _adshrink?.SystemC ?? [];
        const limits = this.props.on_choose_opt();
        const limits_cpi = this.props.on_choose_opt(true);
    ...
    render() {
        ...
        let _isVpn = getNestedObj(() => vpn['host-ip'], false);
            _isVpn = (!!_isVpn && _isVpn == "true") ? true : false;
...
class ComponentGetDestination extends React.Component {
    ...
    on_countdown = (loaded = false) => {
        ...
        return; } else if (mode === '2c_freemium') {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                { blocks && 
                    <button className="ui right labeled icon button primary huge fluid" style={{marginBottom: "10px", backgroundColor: "rgb(220 19 19)"}} onClick={() => this.on_allow_iab() }>Disable your Ad-block and reload <i className="recycle icon"></i> </button>
                }
                { !blocks && 
                    <React.Fragment>
                        { exclusive &&
...
class Prototype extends React.Component {
    ...
    onVpnInfo() {
        ...
        const on_success = (response, newr = false) => {
             ...
             */
            let isVpn = ( 'host-ip' in response && (!!response['host-ip'] && response['host-ip'] == "true") ? true : false ); /** console */ console.log('1) is vpn.. ', isVpn);
        ...
        return (
            <ErrorBoundary main={true}>
                ...
                <style>{" \
                    ...
                    @media only screen and (min-width: 768px) {.100vh {height: 100vh} .custom-padding-seg { padding: 15px 27px 15px 40px !important; } .zero-custom-padding-seg { padding: 0px !important; } } \
